...
export default function About(){
    return(
        <div>
            ...
            <p className="text-lg mb-12">Hello! I am Zaheer Ali, a front-end developer with a passion for creating impactful web experiences. My journey began in GIAIC. I transitioned into front-end development with a strong interest in combining creativity with technology to solve real-world challenges.</p>
